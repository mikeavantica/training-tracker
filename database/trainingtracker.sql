...
INSERT INTO `AuthItem` VALUES ('admin',2,'administrator',NULL,'N;'),('authenticated',2,'authenticated user',NULL,'N;'),('guest',2,'guest user','return Yii::app()->user->isGuest;','N;');
