...
class Athlete extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('height,weight','numerical', 'min'=>1),
    ...
    public function search()
    {
        ...
        if ($this->sex_typeid == 'Female' || $this->sex_typeid == 2) {
            $sex = 2;
        }
    ...
    private function calculate_results(&$data)
    {
        ...
        // Uncomment the lines below to dump parameeters.
//            echo '<pre>'; var_dump($params); echo '</pre>'; die();
        ...
        foreach ($data["WOD"] as $wod) {
            ...
            foreach ($wod["exercises"] as $exercise) {
                ...
                // Uncomment the lines below to dump partial results.
...
//                    echo '<pre> Total Effort '; var_dump($total_effort); echo '</pre>'; 
            ...
            // Uncomment the lines below to dump final results.
