...
class WorkoutDetail extends CActiveRecord
{
    ...
    public function updateCascadeTime($workoutid, $total_time)
    {
        Yii::app()->db->createCommand()->update('workout_detail', array('total_time' => $total_time), 'workoutid = :id', array(':id' => $workoutid));
    }
